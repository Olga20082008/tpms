...
////  beacon
#define USER_ADVERTISE_DATA_BEACON                   "TPMS"
/// Advertising data length - maximum 28 bytes, 3 bytes are reserved to set
#define USER_ADVERTISE_DATA_LEN_BEACON               (sizeof(USER_ADVERTISE_DATA_BEACON)-1)
/// Scan response data
#define USER_ADVERTISE_SCAN_RESPONSE_DATA_BEACON     ""
/// Scan response data length- maximum 31 bytes
#define USER_ADVERTISE_SCAN_RESPONSE_DATA_LEN_BEACON (sizeof(USER_ADVERTISE_SCAN_RESPONSE_DATA_BEACON)-1)
#define USER_DEVICE_NAME_BEACON        "TPMS"
/// Device name length
#define USER_DEVICE_NAME_LEN_BEACON    (sizeof(USER_DEVICE_NAME_BEACON)-1)
...
static const struct default_handlers_configuration  user_default_hnd_conf = {
    ...
    .adv_scenario = DEF_ADV_FOREVER , //DEF_ADV_WITH_TIMEOUT,
